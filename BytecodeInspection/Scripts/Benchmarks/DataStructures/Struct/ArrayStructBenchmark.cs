...
using BenchmarkClass = BytecodeInspection.Benchmarks.SaticArrayStructBenchmark;

namespace BytecodeInspection.Benchmarks
{
    public class ArrayStructBenchmark : Benchmark
    {
        private ArrayStruct<int> m_array;
